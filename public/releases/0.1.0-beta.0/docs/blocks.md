...
```bash
npx shadcn@4.18.0 add https://tis-experience.github.io/ui-foundation/releases/0.1.0-beta.0/r/login-page.json
```
...
```bash
npx shadcn@4.18.0 add https://tis-experience.github.io/ui-foundation/releases/0.1.0-beta.0/r/settings-page.json
```
...
```bash
npx shadcn@4.18.0 add https://tis-experience.github.io/ui-foundation/releases/0.1.0-beta.0/r/team-members.json
```
