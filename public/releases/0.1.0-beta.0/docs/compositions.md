...
```bash
npx shadcn@4.18.0 add https://tis-experience.github.io/ui-foundation/releases/0.1.0-beta.0/r/date-picker.json
```
...
```bash
npx shadcn@4.18.0 add https://tis-experience.github.io/ui-foundation/releases/0.1.0-beta.0/r/form.json
```
...
```bash
npx shadcn@4.18.0 add https://tis-experience.github.io/ui-foundation/releases/0.1.0-beta.0/r/typography.json
```
